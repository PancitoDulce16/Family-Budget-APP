...
function populateSharedMembers() {
  ...
  familyMembers.forEach(member => {
    ...
    // Enable percentage input when checkbox is checked
...
async function handleTransactionSubmit(e) {
  ...
  try {
    ...
    // Validate file size (max 1MB to stay within Firestore limits)
    ...
    const transactionData = {
      ...
      receiptBase64: receiptBase64, // Store as Base64 instead of URL
      isShared,
      sharedWith: [],
